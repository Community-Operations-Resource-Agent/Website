...
export const MapPage = () => {
    ...
    useEffect(() => {
        const isMobileHandler = (e) => setIsMobile(e.matches);

        window.matchMedia("(max-width:768px)").addListener(isMobileHandler);

        return () => {
            window.matchMedia("(max-width:768px)").removeListener(isMobileHandler);
        }
    });
    ...
    return (
        <div className={styles.pageContainer}>
            ...
            <div className={styles.gridContainer}>
                ...
                >
                    Contact CORAbot
                </Button>) : (<MinimizeWebChat className={styles.contactCora} ></MinimizeWebChat>)}
